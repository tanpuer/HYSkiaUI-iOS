...
return false;},getRootHostContext(rootContainer){// console.log(TAG, "getRootHostContext", rootContainer);
return __webpack_require__.g.SkiaUI;},getChildHostContext(parentHostContext,type,rootContainer){// console.log(TAG, "getChildHostContext", type, rootContainer);
...
/* harmony export */ });
function convertStyles(view,styles){Object.keys(styles).forEach(key=>{view[key]=styles[key];});}function comparePrevStylesAndNextStyles(view,type,prevStyles,nextStyles){Object.keys(nextStyles).forEach(key=>{if(nextStyles[key]!==prevStyles[key]){// console.log(TAG, "commitUpdate-style", type, key, nextStyles[key]);
...
return/*#__PURE__*/(0,jsx_runtime.jsx)("page",{style:{width:this.innerWidth,height:this.innerHeight}// onCreate={() => {
...
// }}
,children:/*#__PURE__*/(0,jsx_runtime.jsxs)("scroll",{style:{flex:1,flexDirection:'column',flexWrap:'nowrap',justifyContent:'flex-start',alignItems:'center'},children:[/*#__PURE__*/(0,jsx_runtime.jsx)("text",{style:{textColor:"#00ff00",textSize:50},text:"React Demo:\nusing react-reconciler!"}),/*#__PURE__*/(0,jsx_runtime.jsx)("svg",{style:{width:300,height:300},src:"react.svg"}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{style:{width:200,height:200,backgroundColor:this.state.viewBg},onClick:()=>{this.changeBg();}}),/*#__PURE__*/(0,jsx_runtime.jsx)("button",{style:{width:500,height:100,textSize:50,backgroundColor:"#00ff00",marginTop:50},text:"go to music page",onClick:()=>{console.log(TAG,"go to music page!");SkiaUIRenderer_default().render(/*#__PURE__*/(0,jsx_runtime.jsx)(MusicApp,{props:{from:"app"}}));}}),/*#__PURE__*/(0,jsx_runtime.jsx)("lottie",{style:{width:375,height:420},src:"WorkspacePlanet.json",ref:this.lottieRef,onClick:()=>{if(this.lottieFlag){this.lottieRef.current.pause();}else{this.lottieRef.current.start();}this.lottieFlag=!this.lottieFlag;}}),/*#__PURE__*/(0,jsx_runtime.jsx)("video",{style:{width:this.innerWidth,height:360*this.innerWidth/640},src:"yiluxiangbei.mp4"}),/*#__PURE__*/(0,jsx_runtime.jsx)("shader",{ref:this.shaderRef,style:{width:this.innerWidth,height:520,marginTop:50,marginBottom:50},path:"raining.glsl",textures:["raining.gif"],onClick:()=>{if(this.shaderFlag){this.shaderRef.current.setShaderPath("sincos.glsl",[]);}else{this.shaderRef.current.setShaderPath("raining.glsl",["raining.gif"]);}this.shaderFlag=!this.shaderFlag;}})]})});}changeBg(){console.log("changeBg");const red=Math.floor(Math.random()*256);const green=Math.floor(Math.random()*256);const blue=Math.floor(Math.random()*256);const redHex=(red<16?'0':'')+red.toString(16);const greenHex=(green<16?'0':'')+green.toString(16);const blueHex=(blue<16?'0':'')+blue.toString(16);this.setState({viewBg:`#${redHex}${greenHex}${blueHex}`});}}
;// ./src/index.js
...
/******/ })()
;
//# sourceMappingURL=main.b52a5d3a.js.map
